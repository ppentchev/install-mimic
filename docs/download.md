...
- [install-mimic-0.4.4.tar.bz2](https://devel.ringlet.net/files/misc/install-mimic/install-mimic-0.4.4.tar.bz2)
  (with [a PGP signature](https://devel.ringlet.net/files/misc/install-mimic/install-mimic-0.4.4.tar.bz2.asc))
- [install-mimic-0.4.4.tar.gz](https://devel.ringlet.net/files/misc/install-mimic/install-mimic-0.4.4.tar.gz)
  (with [a PGP signature](https://devel.ringlet.net/files/misc/install-mimic/install-mimic-0.4.4.tar.gz.asc))
- [install-mimic-0.4.4.tar.xz](https://devel.ringlet.net/files/misc/install-mimic/install-mimic-0.4.4.tar.xz)
  (with [a PGP signature](https://devel.ringlet.net/files/misc/install-mimic/install-mimic-0.4.4.tar.xz.asc))
...
[0.4.4]: https://github.com/ppentchev/install-mimic/releases/tag/release%2F0.4.4
